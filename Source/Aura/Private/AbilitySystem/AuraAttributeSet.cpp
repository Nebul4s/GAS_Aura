...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagsToAttributes.Add(GameplayTags.Attributes_Secondary_CriticalHitMultiplier, GetCriticalHitMultiplierAttribute );
...
void UAuraAttributeSet::GetLifetimeReplicatedProps(TArray<class FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_CONDITION_NOTIFY(UAuraAttributeSet, CriticalHitMultiplier, COND_None, REPNOTIFY_Always);
...
void UAuraAttributeSet::PostGameplayEffectExecute(const struct FGameplayEffectModCallbackData& Data)
{
	...
	if (Data.EvaluatedData.Attribute == GetHealthAttribute())
	{
		...
		UE_LOG(LogTemp, Warning, TEXT("Changed health on actor %s, health %f"), *Properties.TargetAvatarActor->GetName(), GetHealth());
	}
...
void UAuraAttributeSet::OnRep_CriticalHitMultiplier(const FGameplayAttributeData& OldCriticalHitMultiplier) const
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UAuraAttributeSet, CriticalHitMultiplier, OldCriticalHitMultiplier)
}
